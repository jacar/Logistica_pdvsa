...
import { PdvsaLogo, CorporacionJFLogo, ArrowRightIcon } from './Icons';
...
const HomeView: React.FC<HomeViewProps> = ({ onNavigateToAdminLogin, onNavigateToDriverSelection }) => {
    return (
        <div 
            ...
            style={{ backgroundImage: "url('https://www.webcincodev.com/blog/wp-content/uploads/2025/08/bg.png')" }}
        >
            {/* Overlay */}
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                <header className="p-4">
                    <div className="container mx-auto flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <PdvsaLogo className="w-12 h-12" />
                            <div>
                                <h1 className="text-xl font-bold text-white tracking-wide">PDVSA - PETROBOSCAN</h1>
                                <p className="text-sm text-gray-300">Sistema de Reportes</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                ...
                <footer className="text-center p-4 text-sm text-gray-300">
                    &copy; {new Date().getFullYear()} PDVSA - PETROBOSCAN. Todos los derechos reservados.
                </footer>
            </div>
        </div>
    );
